"""Main entry point for multi-cloud optimization with GLOBAL NORMALIZATION."""
...
def main():
    """Main execution."""
    parser = argparse.ArgumentParser(description='Multi-Cloud Workload Optimization (V2: Global Normalization)')
    ...
    print("=" * 70)
    print("Multi-Cloud Workload Optimization V2 (Global Normalization)")
    print("=" * 70)
    ...
    if len(algorithms_to_run) > 1:
        print("\n" + "=" * 70)
        print("ALGORITHM COMPARISON (V2: GLOBAL NORMALIZATION)")
        print("=" * 70)
        ...
        if user_preferences:
            ...
            print("\n" + "=" * 70)
            print(f"TOP {args.top_k} SOLUTIONS (GLOBAL NORMALIZATION)")
            print("=" * 70)
            ...
            selection_output_path = Path(args.output_dir) / "global_normalization_results.txt"
            ...
            print(f"\nGlobal normalization results saved to {selection_output_path}")
